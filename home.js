...
//CODE HERE...//$$ on this
 ...
 function canWeDeliver(zipCode){
    for (let i = 0; i < deliveryAreaZipCodes.length; i++){
        if (deliveryAreaZipCodes[i] === zipCode){ //fix this
          return ("You're in our delivery zone!") 
      }else{ (deliveryAreaZipCodes[i] != zipCode)
        return("Sorry, we can't deliver to that address")
      }
    }
}
let deliverable=(canWeDeliver(54454))
...
//CODE HERE
// let secondDeal = deals.replace('March', 'April');
// console.log(secondDeal)

// let joinSpace= deals.join(' ')
